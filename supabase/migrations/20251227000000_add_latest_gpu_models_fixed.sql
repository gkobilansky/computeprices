...
-- Date: 2025-12-27
-- Fixed: Uses WHERE NOT EXISTS instead of ON CONFLICT for compatibility
...
SELECT
  gen_random_uuid(), 'GB200', 'gb200', 384, 'NVIDIA', 'Blackwell',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'gb200');
...
SELECT
  gen_random_uuid(), 'B100', 'b100', 192, 'NVIDIA', 'Blackwell',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'b100');
...
SELECT
  gen_random_uuid(), 'H100 PCIe', 'h100pcie', 80, 'NVIDIA', 'Hopper',
  ...
  14592, 456, 756.00, 51.00, 26.00, 2000, 350, 350
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'h100pcie');
...
SELECT
  gen_random_uuid(), 'H100 NVL', 'h100nvl', 94, 'NVIDIA', 'Hopper',
  ...
  14592, 456, 835.00, 67.00, 34.00, 3958, 400, 400
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'h100nvl');
...
SELECT
  gen_random_uuid(), 'H100 SXM', 'h100sxm', 80, 'NVIDIA', 'Hopper',
  ...
  14592, 456, 990.00, 67.00, 34.00, 3350, 700, 700
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'h100sxm');
...
SELECT
  gen_random_uuid(), 'MI300A', 'mi300a', 128, 'AMD', 'CDNA 3',
  ...
  980.00, 5300, 760, 760
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'mi300a');
...
SELECT
  gen_random_uuid(), 'MI355X', 'mi355x', 288, 'AMD', 'CDNA 4',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'mi355x');
...
SELECT
  gen_random_uuid(), 'MI250X', 'mi250x', 128, 'AMD', 'CDNA 2',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'mi250x');
...
SELECT
  gen_random_uuid(), 'MI250', 'mi250', 128, 'AMD', 'CDNA 2',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'mi250');
...
SELECT
  gen_random_uuid(), 'MI210', 'mi210', 64, 'AMD', 'CDNA 2',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'mi210');
...
SELECT
  gen_random_uuid(), 'MI100', 'mi100', 32, 'AMD', 'CDNA',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'mi100');
...
SELECT
  gen_random_uuid(), 'Gaudi 3', 'gaudi3', 128, 'Intel', 'Gaudi',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'gaudi3');
...
SELECT
  gen_random_uuid(), 'Gaudi 2', 'gaudi2', 96, 'Intel', 'Gaudi',
  ...
  432.00, 2450, 600, 600
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'gaudi2');
...
SELECT
  gen_random_uuid(), 'Max 1550', 'max1550', 128, 'Intel', 'Xe HPC',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'max1550');
...
SELECT
  gen_random_uuid(), 'Max 1100', 'max1100', 48, 'Intel', 'Xe HPC',
...
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'max1100');
...
SELECT
  gen_random_uuid(), 'A30', 'a30', 24, 'NVIDIA', 'Ampere',
  ...
  3584, 224, 165.00, 10.30, 5.20, 933, 165, 165
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'a30');
...
SELECT
  gen_random_uuid(), 'A16', 'a16', 64, 'NVIDIA', 'Ampere',
  ...
  2560, 35.00, 17.50, 800, 250, 250
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'a16');
...
SELECT
  gen_random_uuid(), 'A2', 'a2', 16, 'NVIDIA', 'Ampere',
  ...
  1280, 40, 36.00, 4.50, 200, 60, 60
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'a2');
...
SELECT
  gen_random_uuid(), 'RTX 4070 Ti SUPER', 'rtx4070tisuper', 16, 'NVIDIA', 'Ada Lovelace',
  ...
  8448, 264, 66, 44.10, 672, 256, 285, 285
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4070tisuper');
...
SELECT
  gen_random_uuid(), 'RTX 4070 Ti', 'rtx4070ti', 12, 'NVIDIA', 'Ada Lovelace',
  ...
  7680, 240, 60, 40.09, 504, 192, 285, 285
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4070ti');
...
SELECT
  gen_random_uuid(), 'RTX 4070 SUPER', 'rtx4070super', 12, 'NVIDIA', 'Ada Lovelace',
  ...
  7168, 224, 56, 35.48, 504, 192, 220, 220
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4070super');
...
SELECT
  gen_random_uuid(), 'RTX 4070', 'rtx4070', 12, 'NVIDIA', 'Ada Lovelace',
  'The RTX 4070 provides excellent 1080p and 1440p gaming performance with DLSS 3 support.',
  'Gaming, content creation, AI development',
  false, true, 'mid', '2023-04-13',
  5888, 184, 46, 29.15, 504, 192, 200, 200
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4070');
...
SELECT
  gen_random_uuid(), 'RTX 4060 Ti', 'rtx4060ti', 8, 'NVIDIA', 'Ada Lovelace',
  ...
  4352, 136, 34, 22.06, 288, 128, 160, 160
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4060ti');
...
SELECT
  gen_random_uuid(), 'RTX 4060', 'rtx4060', 8, 'NVIDIA', 'Ada Lovelace',
  ...
  3072, 96, 24, 15.11, 272, 128, 115, 115
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4060');
...
SELECT
  gen_random_uuid(), 'RTX 4080 SUPER', 'rtx4080super', 16, 'NVIDIA', 'Ada Lovelace',
  'The RTX 4080 SUPER delivers near-flagship performance for 4K gaming and content creation.',
  'Gaming, content creation, AI development',
  false, true, 'high', '2024-01-31',
  10240, 320, 80, 52.22, 736, 256, 320, 320
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4080super');
...
SELECT
  gen_random_uuid(), 'RTX 3090 Ti', 'rtx3090ti', 24, 'NVIDIA', 'Ampere',
  ...
  10752, 336, 84, 40.00, 1008, 384, 450, 450
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx3090ti');
...
SELECT
  gen_random_uuid(), 'RTX 3080 Ti', 'rtx3080ti', 12, 'NVIDIA', 'Ampere',
  'The RTX 3080 Ti offers near-3090 performance for 4K gaming with 12GB GDDR6X memory.',
  'Gaming, content creation, AI development',
  false, true, 'high', '2021-06-03',
  10240, 320, 80, 34.10, 912, 384, 350, 350
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx3080ti');
...
SELECT
  gen_random_uuid(), 'RTX 3080', 'rtx3080', 10, 'NVIDIA', 'Ampere',
  'The RTX 3080 delivers excellent 4K gaming performance with Ampere architecture and DLSS support.',
  'Gaming, content creation',
  false, true, 'mid', '2020-09-17',
  8704, 272, 68, 29.77, 760, 320, 320, 320
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx3080');
...
SELECT
  gen_random_uuid(), 'RTX 3070 Ti', 'rtx3070ti', 8, 'NVIDIA', 'Ampere',
  'The RTX 3070 Ti provides excellent 1440p gaming with improved performance over the base 3070.',
  'Gaming, content creation',
  false, true, 'mid', '2021-06-10',
  6144, 192, 48, 21.75, 608, 256, 290, 290
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx3070ti');
...
SELECT
  gen_random_uuid(), 'RTX 3070', 'rtx3070', 8, 'NVIDIA', 'Ampere',
  'The RTX 3070 offers RTX 2080 Ti-level performance for 1440p gaming at a lower price point.',
  'Gaming, content creation',
  false, true, 'mid', '2020-10-29',
  5888, 184, 46, 20.31, 448, 256, 220, 220
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx3070');
...
SELECT
  gen_random_uuid(), 'RTX 5000 Ada', 'rtx5000ada', 32, 'NVIDIA', 'Ada Lovelace',
  ...
  12800, 400, 100, 65.28, 576, 250, 250
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx5000ada');
...
SELECT
  gen_random_uuid(), 'RTX 4500 Ada', 'rtx4500ada', 24, 'NVIDIA', 'Ada Lovelace',
  ...
  7680, 240, 60, 39.63, 432, 210, 210
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4500ada');
...
SELECT
  gen_random_uuid(), 'RTX 4000 Ada', 'rtx4000ada', 20, 'NVIDIA', 'Ada Lovelace',
  ...
  false, true, 'mid', '2023-08-08',
  6144, 192, 48, 26.73, 360, 130, 130
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'rtx4000ada');
...
SELECT
  gen_random_uuid(), 'L4', 'l4', 24, 'NVIDIA', 'Ada Lovelace',
  ...
  7424, 232, 121.00, 30.29, 300, 72, 72
WHERE NOT EXISTS (SELECT 1 FROM public.gpu_models WHERE slug = 'l4');
